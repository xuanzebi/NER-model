...
python ../model/lstm/main.py --use_scheduler=True \
                     --model_save_dir='/opt/hyp/NER/NER-model/saved_models/cyber/cyber_bilstm_mtl/' \
                     --tensorboard_dir='/opt/hyp/NER/NER-model/saved_models/cyber/cyber_bilstm_mtl/runs/' \
                     --batch_size=128 \
                     --optimizer='Adam' \
                     --momentum=0.9 \
