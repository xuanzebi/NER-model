...
def train(model, train_dataloader, dev_dataloader, args, device, tb_writer, label_map, tag, train_logger,dev_test_data):
    ...
    for epoch in tq:
        ...
        print('epoch:{} P:{}, R:{}, F1:{}'.format(epoch,metric['precision-overall'],metric['recall-overall'],metric['f1-measure-overall']))
        train_logger.info('epoch:{} P:{}, R:{}, F1:{}'.format(epoch,metric['precision-overall'],metric['recall-overall'],metric['f1-measure-overall']))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_save_dir', type=str, default='/opt/hyp/NER/NER-model/saved_models/test_msra/', help='Root dir for saving models.')
    ...
    if args.do_test:
        ...
        entity_metric,entity_metric_instance,y_pred_entity = load_predict(test_model,test_dataloader,entity_model_save_dir, \
                                                                        train_logger,index2label,tag,args,device,test_data_raw)
