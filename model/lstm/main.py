...
from model.lstm.cnn_self_attn import CNN_BASE
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_classes', type=str, default='bilstm',choices=['bilstm','bilstm_mtl','bilstm_start_end',"bilstm_data_mtl","cnn"], help='Which model to choose.')
    ...
    if args.do_train:
        args.test = False
        # Dataset
        if args.model_classes in ['bilstm','cnn']:
            if args.use_bert or args.use_elmo:
