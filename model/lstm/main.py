...
from model.lstm.helper import evaluate
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_classes', type=str, default='bilstm',choices=['bilstm','bilstm_mtl','bilstm_start_end',"bilstm_data_mtl"], help='Which model to choose.')
    ...
    parser.add_argument('--use_elmo', default=True, type=str2bool, help='是否使用elmo embedding')
    ...
    if args.do_test:
        ...
        if args.model_classes == 'bilstm':
            if args.use_elmo or args.use_bert:
                test_dataset = load_bert_embedding_data(dev_data_raw,word2idx,label2index,args)
                test_dataloader = DataLoader(dev_dataset, batch_size=args.batch_size)
            else:
