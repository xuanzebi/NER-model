import json 
from lstm.embedding import build_pretrain_embedding,check_coverage
...
def save_embedding():
    ...
    pretrain_word_embedding, unk_words,embedding_index = build_pretrain_embedding('/opt/hyp/NER/embedding/Tencent_AILab_ChineseEmbedding.txt',word2idx)
    print(unk_words)
